    ...
    <el-row :gutter="9">
      ...
      <el-col :span="15">
        ...
        <el-card shadow="hover" :body-style="{ height: '304px'}">
          ...
          <template>
            <slider ref="slider" :pages="news" :sliderinit="sliderinit">
            </slider>
          </template>
        </el-card>
        ...
        news: [
          {
            html: '',
            style: {
              background:'url(static/image/01.jpg)'
            }
          },
          {
            html: '',
            style: {
              background:'url(static/image/02.jpg)'
            }
          },
          {
            html: '',
            style: {
              background:'url(static/image/03.jpg)'
            }
          },
          {
            html: '',
            style: {
              background:'url(static/image/04.jpg)'
            }
          }
        ],
        sliderinit: {
